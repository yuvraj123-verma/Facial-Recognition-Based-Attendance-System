...
message = tk.Label(window, text="Smart Attendance System based on Facial Recognition", bg="royal blue",
...
txt = tk.Entry(window, width=20, bg="royal blue",
               fg="mint cream", font=('times', 15, ' bold '))
txt.place(x=700, y=215)

lbl2 = tk.Label(window, text="Enter Name", width=20, fg="mint cream",
                bg="royal blue", height=2, font=('times', 15, ' bold '))
lbl2.place(x=400, y=300)

txt2 = tk.Entry(window, width=20, bg="royal blue",
                fg="mint cream", font=('times', 15, ' bold '))
txt2.place(x=700, y=315)

lbl3 = tk.Label(window, text="Notification : ", width=20, fg="mint cream",
                bg="royal blue", height=2, font=('times', 15, ' bold underline '))
lbl3.place(x=400, y=400)

message = tk.Label(window, text="", bg="royal blue", fg="mint cream", width=50,
                   height=2, activebackground="royal blue", font=('times', 15, ' bold '))
message.place(x=700, y=400)

lbl3 = tk.Label(window, text="Attendance : ", width=20, fg="mint cream",
                bg="royal blue", height=2, font=('times', 15, ' bold  underline'))
lbl3.place(x=400, y=650)


message2 = tk.Label(window, text="", fg="mint cream", bg="royal blue",
...
def TrackImages():
    ...
    fileName = r"Attendance/Attendance_"+date+"_"+Hour+"-"+Minute+"-"+Second+".csv"
...
clearButton = tk.Button(window, text="Clear", command=clear, fg="mint cream", bg="royal blue",
                        width=20, height=2, activebackground="mint cream", font=('times', 15, ' bold '))
clearButton.place(x=1050, y=200)
clearButton2 = tk.Button(window, text="Clear", command=clear2, fg="mint cream", bg="royal blue",
                         width=20, height=2, activebackground="mint cream", font=('times', 15, ' bold '))
clearButton2.place(x=1050, y=300)
takeImg = tk.Button(window, text="Take Images", command=TakeImages, fg="mint cream", bg="royal blue",
                    width=20, height=3, activebackground="mint cream", font=('times', 15, ' bold '))
takeImg.place(x=200, y=500)
trainImg = tk.Button(window, text="Train Images", command=TrainImages, fg="mint cream",
                     bg="royal blue", width=20, height=3, activebackground="mint cream", font=('times', 15, ' bold '))
trainImg.place(x=500, y=500)
trackImg = tk.Button(window, text="Track Images", command=TrackImages, fg="mint cream",
                     bg="royal blue", width=20, height=3, activebackground="mint cream", font=('times', 15, ' bold '))
trackImg.place(x=800, y=500)
quitWindow = tk.Button(window, text="Quit", command=quit, fg="mint cream", bg="royal blue",
                       width=20, height=3, activebackground="mint cream", font=('times', 15, ' bold '))
